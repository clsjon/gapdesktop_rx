package gapdesktoprx.utils
{
	...
	public class FirstRunUtilities
	{
		public static function populateDatabase():void {
			...
			var healthTag:Tag = new Tag();
			healthTag.name = "Health";
			healthTag.create();
			
			var exampleTag:ExampleTag = new ExampleTag();
			exampleTag.tag = healthTag;
			exampleTag.example = example;
			exampleTag.create();
						
				
			exampleTag = new ExampleTag();
			exampleTag.tag = hivTag;
			exampleTag.example = example;
			exampleTag.create();
			
			var ownTag:Tag = new Tag();
			ownTag.name = "Your own graphs";
			ownTag.create();
